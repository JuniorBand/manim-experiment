...
class Scene3(Scene):
    def construct(self):
        ...
        complete_text = Text("Movimento completo", font_size = 25).next_to(complete_axes, UP)
        ...
        complete_text2 = MathTex("y_{(x)} = -\\frac{x^2 \\cdot g \\cdot (1 + \\tan^2\\theta)}{2V_0} + x \\cdot \\tan\\theta").next_to(text0, ORIGIN, buff=0.0)
        
        self.play(Write(ja))
        self.play(Write(text0))
        self.wait(2)
        self.play(TransformMatchingShapes(ja, text1))
        self.wait(1)
        ...
        simplified_text = MathTex("y_{(x)}", "= -\\frac{g \\cdot (1 + \\tan^2\\theta)}{2V_0} \\cdot", "x^2", "+", "x", "\\cdot \\tan\\theta", font_size=35)

        simplified_text.next_to(complete_text2, UP)
        simplified_rectangle = SurroundingRectangle(simplified_text)
        self.play(TransformMatchingShapes(complete_text2, simplified_text))
        ...
        simplified_text_0 = MathTex("y_0", "= -\\frac{g \\cdot (1 + \\tan^2\\theta)}{2V_0} \\cdot", "x_0^2", "+", "x_0", "\\cdot \\tan\\theta", font_size=35)
########################################################################
        ...
        trajectory_equation = MathTex("\\text{Equação da trajetória}", font_size=40).next_to(j, UP)
        self.play(Write(trajectory_equation))

        simplified_text_0.next_to(j, RIGHT, buff=0.75)
        simplified_text_0_rect = SurroundingRectangle(simplified_text_0, buff=0.1)
        simplified_eq = MathTex("\\text{Equação para $\\theta$}", font_size=40).next_to(simplified_text_0, UP)
        ...
        sol_1 = MathTex("\\text{2 soluções para $\\theta$}", font_size=40).next_to(simplified_text_0, DOWN, buff=1.5)
        sol_2 = MathTex("\\text{1 solução para $\\theta$}", font_size=40).next_to(sol_1, DOWN, buff=1)
        sol_3 = MathTex("\\text{0 soluções para $\\theta$}", font_size=40).next_to(sol_2, DOWN, buff=1)\
        ...
        text_2.next_to(simplified_text_0, DOWN, buff=1.5)
        ...
        quadratic_text = MathTex("\\text{Equação quadrática para $\\tan(\\theta)$}", font_size=40)
        quadratic_text.next_to(new_axes, UP).to_edge(UP)

        self.play(FadeOut(simplified_eq), FadeOut(simplified_text_0), FadeOut(text_2[1]), FadeOut(text_2[2]), FadeOut(text_2[4]), FadeOut(text_2[5]), 
        ...
        sol_text = MathTex("\\text{Soluções}", font_size=40)
        ...
        trigger = False
        def update(mob, string):
            mob.become((MathTex(string, font_size = 35))).next_to(sol_eq, DOWN, buff=0.5)
        ...
        delta = MathTex("\\Delta < 0", font_size = 35)
        delta.next_to(sol_eq, DOWN, buff=0.5)
        self.add(delta)
        ...
        self.play(FadeOut(sol_axes, sol_parabola, sols, delta))
